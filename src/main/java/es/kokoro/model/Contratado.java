...
public class Contratado extends Trabajador{
     ...
     */
    public Contratado(String nombre, String apellidos, String identificador, String nacionalidad, String direccion, String poblacion, String telefono, String email, Long idTrabajador, Delegacion delegacion, Date fechaNac, boolean activo, Long idContratado, Date inicioContract, String finalContract, float salario, String puestoTrabajo, Ong ong) {
