...
public class Particular extends Persona implements IIngreso, IFinanciador {
     ...
     */
    public Particular(Long idPersona, String nombre, String apellidos, String identificador, String nacionalidad, String direccion, String poblacion, String telefono, String email,
                      Long idParticular, Date fechaNac) {
